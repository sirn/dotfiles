...
- Research official documentation for unfamiliar libraries, tools, or APIs. Use `context7` or other relevant research skills when needed; do not infer exact API contracts from memory.
