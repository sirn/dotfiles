...
let
  ...
  wrappedClaudeSynthetic = pkgs.writeScriptBin "claude-synthetic" ''
    ...
    export ANTHROPIC_DEFAULT_OPUS_MODEL=''${ANTHROPIC_DEFAULT_OPUS_MODEL:-hf:zai-org/GLM-4.5}
    export ANTHROPIC_DEFAULT_SONNET_MODEL=''${ANTHROPIC_DEFAULT_SONNET_MODEL:-hf:zai-org/GLM-4.5}
    export ANTHROPIC_DEFAULT_HAIKU_MODEL=''${ANTHROPIC_DEFAULT_HAIKU_MODEL:-hf:zai-org/GLM-4.5}
    export CLAUDE_CODE_SUBAGENT_MODEL=''${CLAUDE_CODE_SUBAGENT_MODEL:-hf:zai-org/GLM-4.5}
