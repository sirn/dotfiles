{ stdenv, fetchurl, clang, AppKit, Cocoa, ScriptingBridge }:
...
stdenv.mkDerivation rec {
  ...
  buildPhase = ''
     ${clang}/bin/clang -O2 -Wall -Wextra -framework AppKit -framework ScriptingBridge -o trash trash.m HGUtils.m HGCLIUtils.m fileSize.m
  '';
