...
commit_json=$(curl -sL https://api.github.com/repos/mitsuhiko/agent-stuff/commits/main)
...
src_hash=$(nix hash convert --hash-algo sha256 --to sri \
  "$(nix-prefetch-url --unpack "https://github.com/mitsuhiko/agent-stuff/archive/${rev}.tar.gz" 2>/dev/null | tail -1)")
