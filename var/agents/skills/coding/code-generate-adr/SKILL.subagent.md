...
description: Create an Architecture Decision Record using specialized subagents when available. Use when asked to write or draft an ADR for an architectural or technical decision.
---
