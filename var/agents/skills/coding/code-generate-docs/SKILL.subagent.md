...
description: Generate or update documentation using specialized subagents when available. Use when asked to add comments, docstrings, module docs, README sections, or reference documentation.
---
