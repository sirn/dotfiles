...
description: Generate or update tests for observable public behavior using specialized subagents when available. Use when asked to add tests, cover edge cases, or improve test coverage.
---
