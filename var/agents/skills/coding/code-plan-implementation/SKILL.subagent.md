...
description: Generate implementation plans using specialized subagents when available. Use when asked to plan how to implement a feature, fix, integration, or code change before modifying files.
---
