...
description: Create safe targeted refactoring plans using specialized subagents when available. Use when asked to plan simplification, cleanup, extraction, renaming, deletion, or module movement without applying changes.
---
