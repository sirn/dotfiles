...
description: Design database schemas, ORM models, migrations, and data relationships using specialized subagents when available. Use when asked to plan schema or persistence changes.
---
