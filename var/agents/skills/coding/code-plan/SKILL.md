---
name: code-plan
description: Generate implementation, API, schema, or refactoring plans. Use when asked to plan, design APIs or database schemas, or create a safe refactoring plan.
---

Generate a comprehensive plan based on task analysis.
...
2. Analyze the codebase:
   ...
   - Understand architectural decisions and module boundaries.
   - Identify integration points with current codebase.
   - Identify over-engineering risks and simpler alternatives.

3. Research and plan:
   - Research official documentation and best practices with WebSearch/WebFetch when needed.
   - Identify security risks and secure implementation patterns.
   - Consider simplicity constraints: no-code alternatives, boring solutions, minimal scope, and avoiding premature abstractions.
   - Identify recommended libraries/tools only when they are necessary and research-backed.
