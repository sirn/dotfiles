...
description: Review code for performance bottlenecks, algorithmic complexity, memory usage, and unnecessary work using specialized subagents when available. Use when asked for performance review or optimization opportunities.
---
