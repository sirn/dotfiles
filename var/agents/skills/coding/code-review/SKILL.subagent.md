---
name: code-review
description: Review code for correctness, quality, conventions, simplicity, security, and overall health using specialized subagents when available. Use when asked for a general or full code review.
---
