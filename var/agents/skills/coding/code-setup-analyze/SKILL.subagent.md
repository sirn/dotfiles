...
description: Analyze project tooling and development workflows without changing files using specialized subagents when available. Use when asked to inspect project setup, detect tooling, or summarize available commands.
---
