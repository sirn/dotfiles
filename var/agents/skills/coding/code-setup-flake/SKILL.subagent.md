...
description: Create or update a minimal Nix flake for project development using specialized subagents when available. Use when asked to add a flake, update devShells, or set up Nix-based development.
---
