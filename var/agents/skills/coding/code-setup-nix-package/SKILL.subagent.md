...
description: Add a verified nixpkgs package to a Nix development environment using specialized subagents when available. Use when asked to add a package to flake.nix, shell.nix, default.nix, or a devShell.
---
