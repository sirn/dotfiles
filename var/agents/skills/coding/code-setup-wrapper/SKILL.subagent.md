...
description: Create minimal development wrapper scripts using specialized subagents when available. Use when asked to add scripts for common test, lint, format, build, dev, or project commands.
---
