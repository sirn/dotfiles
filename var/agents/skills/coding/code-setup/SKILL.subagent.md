---
name: code-setup
description: Analyze project tooling and set up development helpers such as wrapper scripts, Nix flakes, or Nix packages using specialized subagents when available. Use when asked to inspect project setup, create wrappers, add a flake, or add a Nix package.
---
