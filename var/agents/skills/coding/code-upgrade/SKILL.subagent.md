---
name: code-upgrade
description: Safely upgrade dependencies or migrate framework versions using specialized subagents when available. Use when user asks to upgrade, update dependencies, or migrate to a new version.
---
